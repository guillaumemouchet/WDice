...
public enum ComponentXeox implements Component_I
	...
	JOYSTICK_LEFT_UP_DOWN("ly", -0.996124208, 0.996093631, -1, 1), //
	JOYSTICK_RIGHT_UP_DOWN("ry", -0.996124208, 0.996093631, -1, 1), //
	JOYSTICK_LEFT_LEFT_RIGHT("lx", -0.996124208, 0.996093631, -1, 1), //
	JOYSTICK_RIGHT_LEFT_RIGHT("lx", -0.996124208, 0.996093631, -1, 1); //
	/*------------------------------------------------------------------*\
	|*							Constructeurs							*|
	\*------------------------------------------------------------------*/
