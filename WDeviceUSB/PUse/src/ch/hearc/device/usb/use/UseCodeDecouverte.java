...
/**
 * Tres utile pour fabriquer les type enum de ComponentXXX (see xeox example, interlink example, logitech interlink example...)
 */
public class UseCodeDecouverte
	...
	public static void main()
		{
		System.out.println("[USB] : Discovery Device (name, id, value, ...) :\n");
		codeDecouverte();
		}
	...
	private static void codeDecouverte()
		...
		while(true)
			...
			if (tabController.length == 0)
				{
				System.out.println("[USB] : no controllers found");
				System.exit(0);
				}
